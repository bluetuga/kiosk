...
| Build demora 60-120 min (devido ao `--platform linux/amd64` no Apple Silicon) | Container mantém mount ativo; log em `build.log`. Reiniciar laptop durante build aborta. |
